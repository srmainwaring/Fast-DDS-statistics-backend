...
TEST_F(statistics_backend_tests, internal_callbacks_negative_cases)
{
    ...
    auto result = StatisticsBackendTest::get_entities(EntityKind::DDS_DOMAIN, EntityId(7));
...
GTEST_INSTANTIATE_TEST_MACRO(
    ...
    ::testing::Values(
        ...
        // ALL - DDS_DOMAIN
        std::make_tuple(EntityKind::DDS_DOMAIN, 0, std::vector<size_t>{7, 8}),
        // ALL - PARTICIPANT
        ...
        // HOST - DDS_DOMAIN
        std::make_tuple(EntityKind::DDS_DOMAIN, 2, std::vector<size_t> { 8 }),
        // HOST - DOMAIN: none
        std::make_tuple(EntityKind::DDS_DOMAIN, 1, std::vector<size_t> { }),
        // HOST - PARTICIPANT
        ...
        // USER - DDS_DOMAIN
        std::make_tuple(EntityKind::DDS_DOMAIN, 4, std::vector<size_t> { 8 }),
        // USER - DDS_DOMAIN: none
        std::make_tuple(EntityKind::DDS_DOMAIN, 3, std::vector<size_t> { }),
        // USER - PARTICIPANT
        ...
        // PROCESS - DDS_DOMAIN
        std::make_tuple(EntityKind::DDS_DOMAIN, 6, std::vector<size_t> { 8 }),
        // PROCESS - DDS_DOMAIN: none
        std::make_tuple(EntityKind::DDS_DOMAIN, 5, std::vector<size_t> { }),
        // PROCESS - PARTICIPANT
        ...
        // PARTICIPANT - DDS_DOMAIN
        std::make_tuple(EntityKind::DDS_DOMAIN, 10, std::vector<size_t> { 8 }),
        std::make_tuple(EntityKind::DDS_DOMAIN, 9, std::vector<size_t> { 8 }),
        ...
        // TOPIC - DDS_DOMAIN
        std::make_tuple(EntityKind::DDS_DOMAIN, 12, std::vector<size_t> { 8 }),
        std::make_tuple(EntityKind::DDS_DOMAIN, 11, std::vector<size_t> { 8 }),
        // TOPIC - PARTICIPANT
        ...
        // DATAREADER - DDS_DOMAIN
        std::make_tuple(EntityKind::DDS_DOMAIN, 15, std::vector<size_t> { 8 }),
        std::make_tuple(EntityKind::DDS_DOMAIN, 13, std::vector<size_t> { 8 }),
        ...
        // DATAWRITER - DDS_DOMAIN
        std::make_tuple(EntityKind::DDS_DOMAIN, 19, std::vector<size_t> { 8 }),
        std::make_tuple(EntityKind::DDS_DOMAIN, 17, std::vector<size_t> { 8 }),
        ...
        // LOCATOR - DDS_DOMAIN
        std::make_tuple(EntityKind::DDS_DOMAIN, 14, std::vector<size_t> { 8 }),
        std::make_tuple(EntityKind::DDS_DOMAIN, 16, std::vector<size_t> { 8 }),
        std::make_tuple(EntityKind::DDS_DOMAIN, 18, std::vector<size_t> { 8 }),
        std::make_tuple(EntityKind::DDS_DOMAIN, 20, std::vector<size_t> { 8 }),
        // LOCATOR - PARTICIPANT
